...
def build_study_prompt(book: str, author: str, chapters: str) -> str:
    return (
        ...
        f"6. Cite sempre a referência exata (capítulo, página, seção) quando possível.\n"
        f"7. Explique os conceitos de forma completa, incluindo contexto histórico e doutrinário.\n"
        f"8. Conecte os ensinamentos com a prática espírita do dia a dia.\n"
        f"9. Use vocabulário acessível, mas sem simplificar demais o conteúdo.\n"
        f"10. Mantenha um tom acolhedor, educativo e esclarecedor.\n"
        f"11. Organize o texto com tópicos, subtópicos e parágrafos bem estruturados.\n"
        f"12. Ao final, inclua um resumo dos pontos principais abordados."
    )
